...
Vue-Daily Learn 是一款基于 Vue 3 + Vite 开发的个人英语学习与日记记录应用。旨在帮助用户通过每日单词记忆、句子填空练习以及日记书写，建立持续学习的习惯并记录生活点滴。

### 核心功能

- **单词学习**：使用 CET4/CET6 词汇数据，通过选择题形式进行分组学习，支持进度追踪与掌握度统计
- **句子练习**：中英文句子对照填空，支持自定义添加句子，帮助提升双语表达能力
- **每日一记**：日历驱动的日记记录系统，支持 Markdown 编辑、图片插入、心情标记
- **往日迹忆**：历史日记浏览与统计，支持列表/卡片视图切换，Markdown 预览
- **任务管理**：可拖拽排序的任务清单，帮助规划每日学习目标
